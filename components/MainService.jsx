        ...
        <>
            <div id='service' className={`relative ${props.sectionPadding}`}>
                ...
                <div className={`${props.showHideClass}`}>
                    <img className='absolute left-[5%] top-[12%] animate-animUpDown' src="/images/main/service-element-1.png" alt="" />
                    <img className='absolute c3xl:right-[5%] cxl:right-[2%] top-[48%] animate-animUpDown z-20' src="/images/main/service-element-2.png" alt="" />
