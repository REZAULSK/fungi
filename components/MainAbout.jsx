...
export function MainAbout(props) {
        ...
        <>
            <div id='about' className={`relative ${props.sectionPadding}`}>
                ...
                <div className={`${props.showHideClass}`}>
                    <img className='absolute c3xl:right-[10%] cxl:right-[8%] -top-[8%] animate-animUpDown' src={props.shapeOne} alt="" />
                    <img className='absolute c3xl:left-[5%] cxl:left-[2%] -bottom-[3%] animate-animUpDown' src={props.shapeTwo} alt="" />
                </div>
            </div>
        </>
    )
