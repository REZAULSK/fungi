...
export function HeroSidebar(props) {
    ...
    return (
        <>
            <section id='home' className="home main-hero relative z-10 overflow-hidden text-white cxl:h-screen" style={{ backgroundImage: "url('../images/sidebar/hero-bg.jpg')", backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundSize: "cover" }}>
                        ...
                        <div key={index} className="cxl:h-screen h-full flex relative z-10 cxl:justify-between justify-center items-center c2xl:mt-0 cxl:mt-[30px] flex-col cxl:flex-row">
                            <div className="cxl:order-last cxl:w-1/2 px-3 w-full">
                                <Tilt options={defaultOptions}>
                                    <div className="relative flex justify-center cxl:justify-end sidebar_image_wrapper image-wrapper cxl:mt-4 cxl:mb-0 mt-[136px] csm:mt-[160px] mb-[40px] csm:mb-[70px] c3xl:right-0 c2xl:right-[40px] cxl:right-[60px]">
                                        <ul className="hero-facts hidden csm:flex space-x-8">
                                            <li className="bg-white dark:bg-[#2f2f2f] absolute c3xl:px-[24px] c3xl:py-[18px] cxl:p-4 px-4 py-[14px] text-start shadow-lg rounded-[10px] flex items-center justify-center gap-4 md:top-[60px] top-[48px] cxl:left-[120px] c2xl:left-[110px] c3xl:left-[60px] md:left-[80px] left-0">
                                            ...
                                            <li className="bg-white dark:bg-[#2f2f2f] absolute c3xl:px-[24px] c3xl:py-[18px] cxl:p-4 px-4 py-[14px] text-start shadow-lg rounded-[10px] flex items-center justify-center gap-4 right-0 md:right-[85px] cxl:-right-[80px] c2xl:-right-[60px] c3xl:-right-[60px] md:bottom-[60px] bottom-[48px]">
                ...
                <div className="hidden c3xl:block">
                    <img className='absolute c3xl:left-[4%] c3xl:top-[22%] c2xl:left-[1%] c2xl:top-[16%] cxl:left-[3%] cxl:top-[20%] animate-animUpDown' src="/images/main/hero-element-1.png" alt="" />
                    ...
                    <img className='absolute right-[52%] top-[30%] animate-animUpDown' src="/images/main/hero-element-4.png" alt="" />
                    <img className='absolute c2xl:left-[6%] cxl:left-[1%] c3xl:bottom-[18%] c2xl:bottom-[12%] cxl:bottom-[8%] animate-animMove' src="/images/main/hero-element-5.png" alt="" />
                </div>
            </section>
        </>
    )
