                        ...
                        {menuItems.map((section) => (
                            <li key={section.title} className="nav-item">
                                <ScrollLink
                                    ...
                                    smooth={true}
                                    duration={500}
                                    className={`nav-link text-[18px] font-bold cursor-pointer ${activeLink === section.title ? props.activeColor : 'text-[#222222] dark:text-white hover:text-[#7371f9]  dark:hover:text-[#7371f9]'}`}
