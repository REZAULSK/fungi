      ...
      <div>
        <div className="fixed top-0 left-0 z-[999] w-full">
          <CommonHeader
            ...
            primaryColor="text-[#ffffff] hover:text-main-primary transition-all duration-300"
        ...
        <MainAbout
          ...
          shapeOne="/images/main/about-element-1.png"
          shapeTwo="/images/main/about-element-2.png"
        />
